import{_ as F,l as f,f as U,m as w,G as i,o as m,c as P,b as d,F as _,h as k,n as x,t as D,p as T,a as G}from"./index--Du0Agjv.js";const E=r=>(T("data-v-710f187e"),r=r(),G(),r),L=E(()=>d("h3",null,"课后练习",-1)),M=["onClick"],o=`
  // 点到直线的距离
...
`,$={__name:"Practice",setup(r){const u=[{name:"正方形"},{name:"正六边形"},{name:"椭圆"},{name:"正方形环"},{name:"正六边形环"},{name:"椭圆环"},{name:"正六角星"},{name:"正六角星环"}],s=f(5),e=f(null),p=`
  #ifdef GL_ES
  precision highp float;
  #endif
...
`;let t,n;U(()=>{c(s.value),l(),w(s,()=>{c(s.value),l()})});const c=g=>{switch(g){case 0:t=new i(e.value),n=t.compileSync(p,a),t.useProgram(n);break;case 1:t=new i(e.value),n=t.compileSync(b,a),t.useProgram(n);break;case 2:t=new i(e.value),n=t.compileSync(X,a),t.useProgram(n);break;case 3:t=new i(e.value),n=t.compileSync(S,a),t.useProgram(n);break;case 4:t=new i(e.value),n=t.compileSync(I,a),t.useProgram(n);break;case 5:t=new i(e.value),n=t.compileSync(Y,a),t.useProgram(n);break;case 6:t=new i(e.value),n=t.compileSync(h,a),t.useProgram(n);break;case 7:t=new i(e.value),n=t.compileSync(y,a),t.useProgram(n);break}},l=()=>{t.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}]),t.render()};return(g,z)=>(m(),P(_,null,[L,d("div",null,[(m(),P(_,null,k(u,(C,v)=>d("span",{class:x(["filter-type",{active:s.value===v}]),onClick:q=>s.value=v},D(C.name),11,M)),64))]),d("canvas",{ref_key:"glRef",ref:e,width:"512",height:"512"},null,512)],64))}},R=F($,[["__scopeId","data-v-710f187e"]]);export{R as default};
