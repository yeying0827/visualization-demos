import{_ as I,y,f as L,G as $,z as G,o as B,c as D,b as g,F as k,u as R,T as u,U as z,A,t as X,p as Y,a as q}from"./index-3qJZoPZt.js";const K=c=>(Y("data-v-ee03f3e3"),c=c(),q(),c),N=K(()=>g("h3",null,"课后练习",-1)),V=["onClick"],x=`
...
`;let e;L(()=>{e=new $(o.value),w(i.value),d(),G(i,()=>{w(i.value)})});const w=l=>{switch(l){case 0:const F=e.compileSync(P,x);e.useProgram(F),d(),function(){const t=b();function r(n){e.bindFBO(null),e.uniforms.uTime=n/1e3,e.uniforms.tMap=t.texture,e.render(),e.bindFBO(t.writeFBO),e.uniforms.tMap=t.texture,t.swap(),e.render(),requestAnimationFrame(r)}r(0)}();break;case 1:const h=e.compileSync(T,x);e.useProgram(h),d(),function(){const t=b(),{width:r,height:n}=o.value,m=o.value.getBoundingClientRect();let a=!1,p=[0,0];const f=s=>{const C=(s.clientX-m.left)/r,E=(n-(s.clientY-m.top))/n;p=[C,E]};o.value.addEventListener("mousedown",s=>{f(s),o.value.addEventListener("mousemove",f),a=!0}),o.value.addEventListener("mouseup",s=>{a=!1,o.value.removeEventListener("mousemove",f)}),e.uniforms.isMouseDown=0,e.uniforms.mousePos=[0,0];function M(s){a?(e.uniforms.mousePos=p,e.uniforms.isMouseDown||(e.uniforms.isMouseDown=1)):e.uniforms.isMouseDown&&(e.uniforms.isMouseDown=0),e.bindFBO(null),e.uniforms.uTime=s/1e3,e.uniforms.tMap=t.texture,e.render(),e.bindFBO(t.writeFBO),e.uniforms.tMap=t.texture,e.render(),t.swap(),requestAnimationFrame(M)}M(0)}();break;case 2:const v=e.compileSync(S,x);e.useProgram(v),d(),e.uniforms.stage=0,e.render();const _=e.createFBO();e.bindFBO(_),e.render(),e.bindFBO(null),e.uniforms.stage=1,e.render();const U=t=>{const{offsetX:r,offsetY:n}=t,{width:m,height:a}=o.value.getBoundingClientRect(),p=r/m,f=1-n/a;e.uniforms.u_mouse=[p,f],e.uniforms.stage=2,e.uniforms.tSource=_.texture,e.render()};(()=>{e.bindFBO(null),o.value.addEventListener("mousemove",U)})();break}},b=()=>({readFBO:e.createFBO(),writeFBO:e.createFBO(),get texture(){return this.readFBO.texture},swap(){const l=this.writeFBO;this.writeFBO=this.readFBO,this.readFBO=l}}),d=()=>{e.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}])};return(l,F)=>(B(),D(k,null,[N,g("div",null,[(B(),D(k,null,R(O,(h,v)=>g("span",{class:A(["filter-type",{active:i.value===v}]),onClick:_=>i.value=v},X(h.name),11,V)),64))]),g("canvas",{width:"512",height:"512",ref_key:"glRef",ref:o},null,512)],64))}},Q=I(j,[["__scopeId","data-v-ee03f3e3"]]);export{Q as default};
