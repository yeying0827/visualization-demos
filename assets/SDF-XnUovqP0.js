import{_ as u,l as f,f as S,m as F,G as c,o as g,c as p,b as s,F as m,h as y,n as C,t as x,p as k,a as z}from"./index-g0v-nOv3.js";const _=n=>(k("data-v-564cd14e"),n=n(),z(),n),U=_(()=>s("h3",null,"符号距离场（Signed Distance Field，SDF）",-1)),w=_(()=>s("p",null,"符号距离场的主要作用是快速查询任意一点到场景中物体表面的最短距离。",-1)),P=["onClick"],r=`
...
`,B={__name:"SDF",setup(n){const b=[{name:"平行线"},{name:"斜线纹"},{name:"圆环"},{name:"三角环"}],t=f(3),o=f(null);let e,a;S(()=>{i(t.value),l(),F(t,()=>{i(t.value),l()})});const i=d=>{switch(d){case 0:e=new c(o.value),a=e.compileSync(D,r),e.useProgram(a);break;case 1:e=new c(o.value),a=e.compileSync(G,r),e.useProgram(a);break;case 2:e=new c(o.value),a=e.compileSync(E,r),e.useProgram(a);break;case 3:e=new c(o.value),a=e.compileSync(L,r),e.useProgram(a);break}},l=()=>{e.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}]),e.render()};return(d,I)=>(g(),p(m,null,[U,w,s("div",null,[(g(),p(m,null,y(b,(h,v)=>s("span",{class:C(["filter-type",{active:t.value===v}]),onClick:R=>t.value=v},x(h.name),11,P)),64))]),s("canvas",{ref_key:"glRef",ref:o,width:"512",height:"512"},null,512)],64))}},M=u(B,[["__scopeId","data-v-564cd14e"]]);export{M as default};
