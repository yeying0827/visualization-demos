import{_ as x,k as m,f as y,G as h,l as b,o as p,c as _,b as a,F as u,g as w,n as P,t as F,p as S,a as U}from"./index-kUdbjN4z.js";const k=s=>(S("data-v-5423e105"),s=s(),U(),s),C=k(()=>a("h3",null,"随机效果",-1)),R=["onClick"],n=`
...
`,A={__name:"RandomPattern",setup(s){const g=[{name:"生成随机色块"},{name:"动态移动的长方块"},{name:"迷宫"}],t=m(2),c=m(null);let e,o;y(()=>{e=new h(c.value),i(t.value),l(),b(t,()=>{i(t.value),l()})});const i=v=>{switch(v){case 0:o=e.compileSync(G,n),e.useProgram(o);break;case 1:o=e.compileSync(I,n),e.useProgram(o),e.uniforms.uTime=0,requestAnimationFrame(function d(r){e.uniforms.uTime=4*r/1e3,requestAnimationFrame(d)});break;case 2:o=e.compileSync(T,n),e.useProgram(o),e.uniforms.rows=20;break}},l=()=>{e.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}]),e.render()};return(v,d)=>(p(),_(u,null,[C,a("div",null,[(p(),_(u,null,w(g,(r,f)=>a("span",{class:P(["pattern-type",{active:t.value===f}]),onClick:D=>t.value=f},F(r.name),11,R)),64))]),a("canvas",{ref_key:"canvasRef",ref:c,id:"random-pattern",width:"512",height:"512"},null,512)],64))}},L=x(A,[["__scopeId","data-v-5423e105"]]);export{L as default};
