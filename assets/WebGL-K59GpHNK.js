import{W as g}from"./WebGL-sPHJiv-y.js";import{a as l}from"./parametric-nO2vAiAA.js";import{e as i}from"./polygon-CiuQVPYG.js";import{_ as p,f as d,o as _,c as h,F as b,p as u,a as x,b as t}from"./index-jvjASubQ.js";import"./vector2d-Djg1LsDx.js";const c=o=>(u("data-v-6c49090d"),o=o(),x(),o),f=c(()=>t("h3",null,"WebGL色盘",-1)),m=c(()=>t("p",null,"利用hsv和rgb互相转换的GLSL代码，实现两个色盘",-1)),y=c(()=>t("p",null,"左边：半径对应饱和度；右边：半径对应明度",-1)),P=c(()=>t("canvas",{width:"512",height:"512"},null,-1)),q=c(()=>t("p",{style:{"text-align":"left"}},"CSS实现色盘",-1)),w=c(()=>t("div",{class:"circle"},null,-1)),C=`
