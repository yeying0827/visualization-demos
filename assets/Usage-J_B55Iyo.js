import{_ as T,l as u,f as U,m as w,G as f,o as m,c as b,b as o,F as p,h as C,n as F,t as M,p as S,a as k}from"./index-g0v-nOv3.js";const D="/visualization-demos/assets/road-0DMu_tsG.jpeg",j="/visualization-demos/assets/planet-G4x4Tt8C.jpeg",G=t=>(S("data-v-1b9637b1"),t=t(),k(),t),P=G(()=>o("h3",null,"实际用途",-1)),B=["onClick"],g=`
  // 点到直线的距离
...
`;let e,c;U(()=>{v(a.value),l(),w(a,()=>{v(a.value),l()})});const v=s=>{switch(s){case 0:e=new f(i.value),c=e.compileSync(x,_),e.useProgram(c),async function(){const n=await e.loadTexture(D);e.uniforms.tMap=n,r(0)}();break;case 1:e=new f(i.value),c=e.compileSync(y,_),e.useProgram(c),async function(){const n=await e.loadTexture(j);e.uniforms.tMap=n,r(0)}();break}},r=s=>{e.uniforms.uTime=s,requestAnimationFrame(r)},l=()=>{e.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}]),e.render()};return(s,n)=>(m(),b(p,null,[P,o("div",null,[(m(),b(p,null,C(h,(z,d)=>o("span",{class:F(["filter-type",{active:a.value===d}]),onClick:R=>a.value=d},M(z.name),11,B)),64))]),o("canvas",{ref_key:"glRef",ref:i,width:"512",height:"512"},null,512)],64))}},E=T(I,[["__scopeId","data-v-1b9637b1"]]);export{E as default};
