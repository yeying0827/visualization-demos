import{G as c}from"./gl-renderer--j5iNyII.js";import{o as n,a as i,c as v,F as d,b as s}from"./index-a4tGsWeP.js";import"./_commonjsHelpers-5-cIlDoe.js";const l=s("h3",null,"WebGL demo（重复图案）",-1),m=s("canvas",{width:"512",height:"512"},null,-1),f={__name:"WebGL",setup(u){return n(()=>{const t=`
  ...
  `,r=document.querySelector("canvas"),e=new c(r),a=e.compileSync(o,t);e.useProgram(a),e.uniforms.rows=32,e.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}]),e.render()}),(t,o)=>(i(),v(d,null,[l,m],64))}};export{f as default};
