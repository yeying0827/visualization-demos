import{G as t}from"./gl-renderer--j5iNyII.js";import{d as o}from"./glslFunc-l-MaHrBn.js";import{_ as k,r as f,o as w,w as G,a as m,c as p,b as i,F as _,d as D,n as E,t as I,p as L,f as M}from"./index-a4tGsWeP.js";import"./_commonjsHelpers-5-cIlDoe.js";const T=c=>(L("data-v-09f7641e"),c=c(),M(),c),x=T(()=>i("h3",null,"课后练习",-1)),q=["onClick"],s=`
...
`,B={__name:"Practice",setup(c){const u=[{name:"正方形"},{name:"正六边形"},{name:"椭圆"},{name:"正方形环"},{name:"正六边形环"},{name:"椭圆环"},{name:"正六角星"},{name:"正六角星环"}],n=f(5),r=f(null),h=`
  #ifdef GL_ES
