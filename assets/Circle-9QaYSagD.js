import{_ as F,l as v,f as S,m as w,G as i,q as U,o as p,c as h,b as o,F as _,h as k,E as b,H as x,n as R,t as T,p as P,a as D}from"./index-g0v-nOv3.js";const y=r=>(P("data-v-6ce3414a"),r=r(),D(),r),E=y(()=>o("h3",null,"绘制圆形",-1)),G=y(()=>o("p",null,"根据点坐标到圆心的距离来生成颜色",-1)),L=["onClick"],l=`
...
`,q={__name:"Circle",setup(r){const C=[{name:"模糊的圆"},{name:"清晰的圆1（step）"},{name:"清晰的圆2（smoothstep）"},{name:"渐显渐隐效果"}],t=v(2),n=v(null),d=v(null);let e,a;S(()=>{g(t.value),u(),w(t,()=>{g(t.value),u()})});const g=f=>{switch(f){case 0:e=new i(n.value),a=e.compileSync(M,l),e.useProgram(a);break;case 1:e=new i(n.value),a=e.compileSync(z,l),e.useProgram(a);break;case 2:e=new i(n.value),a=e.compileSync(B,l),e.useProgram(a);break;case 3:e=new i(d.value),async function(){a=e.compileSync(I,l),e.useProgram(a);const m=await e.loadTexture(U);e.uniforms.tMap=m,e.uniforms.uTime=0,requestAnimationFrame(function c(s){e.uniforms.uTime=s/2e3,requestAnimationFrame(c)}),e.uniforms.uResolution=[1e3,554]}();break}},u=()=>{e.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}]),e.render()};return(f,m)=>(p(),h(_,null,[E,G,o("div",null,[(p(),h(_,null,k(C,(c,s)=>o("span",{class:R(["filter-type",{active:t.value===s}]),onClick:A=>t.value=s},T(c.name),11,L)),64))]),b(o("canvas",{ref_key:"glRef",ref:n,width:"512",height:"512"},null,512),[[x,t.value!==3]]),b(o("canvas",{ref_key:"girlRef",ref:d,width:"1000",height:"554"},null,512),[[x,t.value===3]])],64))}},H=F(q,[["__scopeId","data-v-6ce3414a"]]);export{H as default};
