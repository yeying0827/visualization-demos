import{G as x}from"./gl-renderer--j5iNyII.js";import{_ as y,r as m,o as h,w as b,a as p,c as _,b as r,F as u,d as w,n as P,t as F,p as S,f as U}from"./index-a4tGsWeP.js";import"./_commonjsHelpers-5-cIlDoe.js";const C=s=>(S("data-v-5423e105"),s=s(),U(),s),k=C(()=>r("h3",null,"随机效果",-1)),R=["onClick"],n=`
...
`,A={__name:"RandomPattern",setup(s){const g=[{name:"生成随机色块"},{name:"动态移动的长方块"},{name:"迷宫"}],t=m(2),c=m(null);let e,o;h(()=>{e=new x(c.value),i(t.value),l(),b(t,()=>{i(t.value),l()})});const i=v=>{switch(v){case 0:o=e.compileSync(G,n),e.useProgram(o);break;case 1:o=e.compileSync(I,n),e.useProgram(o),e.uniforms.uTime=0,requestAnimationFrame(function d(a){e.uniforms.uTime=4*a/1e3,requestAnimationFrame(d)});break;case 2:o=e.compileSync(T,n),e.useProgram(o),e.uniforms.rows=20;break}},l=()=>{e.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}]),e.render()};return(v,d)=>(p(),_(u,null,[k,r("div",null,[(p(),_(u,null,w(g,(a,f)=>r("span",{class:P(["pattern-type",{active:t.value===f}]),onClick:D=>t.value=f},F(a.name),11,R)),64))]),r("canvas",{ref_key:"canvasRef",ref:c,id:"random-pattern",width:"512",height:"512"},null,512)],64))}},q=y(A,[["__scopeId","data-v-5423e105"]]);export{q as default};
