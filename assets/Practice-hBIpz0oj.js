import{y as m,f as v,G as l,o as f,c as d,b as n,F as u}from"./index-8v8F2D54.js";const g=n("h3",null,"课后练习",-1),_=`
...
`,x={__name:"Practice",setup(h){const r=m(null);let e,t;v(()=>{e=new l(r.value),a(0),c()});const a=o=>{switch(o){case 0:t=e.compileSync(p,_),e.useProgram(t),e.uniforms.uTime=0,requestAnimationFrame(function i(s){e.uniforms.uTime=.001*s,requestAnimationFrame(i)});break}},c=()=>{e.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}]),e.render()};return(o,i)=>(f(),d(u,null,[g,n("canvas",{ref_key:"glRef",ref:r,width:"512",height:"512"},null,512)],64))}};export{x as default};
