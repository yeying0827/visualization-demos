import{W as h}from"./WebGL-WYqHgG1q.js";import{_ as g,f as M,o as x,c as P,F as w,p as b,a as F,b as _}from"./index-pk9eWFZd.js";import"./polygon-Ez1DsPad.js";import"./vector2d-Djg1LsDx.js";const f=e=>(b("data-v-391a0353"),e=e(),F(),e),y=f(()=>_("h3",null,"例子：粒子动画",-1)),I=f(()=>_("canvas",{width:"512",height:"512"},null,-1)),A={__name:"GrainAnimation",setup(e){let o;const l=new Float32Array([-1,-1,0,1,1,-1]);let i=[];M(()=>{const t=document.querySelector("canvas").getContext("webgl"),r=`
  ...
  `;o=new h(t,r,n),o.createWebGLProgram(),o.bufferPosition(l),o.readPosition(),requestAnimationFrame(m)});function m(){const{gl:a}=o;for(let t=0;t<5*Math.random();t++)i.push(p());a.clear(a.COLOR_BUFFER_BIT),i.forEach(t=>{t.u_time=(performance.now()-t.startTime)/1e3,d(t),a.drawArrays(a.TRIANGLES,0,l.length/2)}),i=i.filter(t=>t.u_time<=t.u_duration),requestAnimationFrame(m)}function d({u_color:a,u_rotation:t,u_scale:r,u_time:n,u_duration:c,u_dir:s}){const u=[["u_color",a,"4fv"],["u_rotation",t,"1f"],["u_scale",r,"1f"],["u_time",n,"1f"],["u_duration",c,"1f"],["u_dir",s,"2fv"]];o.setUniforms(u)}function p(){const a=[Math.random(),Math.random(),Math.random(),1],t=Math.random()*Math.PI,r=Math.random()*.05+.03,n=0,c=3,s=Math.random()*Math.PI*2,u=[Math.cos(s),Math.sin(s)],v=performance.now();return{u_color:a,u_rotation:t,u_scale:r,u_time:n,u_duration:c,u_dir:u,startTime:v}}return(a,t)=>(x(),P(w,null,[y,I],64))}},k=g(A,[["__scopeId","data-v-391a0353"]]);export{k as default};
