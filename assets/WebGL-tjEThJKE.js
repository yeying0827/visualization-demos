import{G as t}from"./gl-renderer--j5iNyII.js";import{_ as x,r as _,o as w,w as G,a as g,c as p,b as c,F as d,d as P,n as L,t as E,p as $,f as I}from"./index-a4tGsWeP.js";import"./_commonjsHelpers-5-cIlDoe.js";const B=l=>($("data-v-ca4f877b"),l=l(),I(),l),R=B(()=>c("h3",null,"WebGL demo",-1)),D=["onClick"],s=`
  vec2 polar(vec2 st) {
...
`,W={__name:"WebGL",setup(l){const h=[{name:"圆"},{name:"玫瑰"},{name:"玫瑰花瓣数动态变化"},{name:"花瓣线"},{name:"横置的葫芦"},{name:"花苞图案"}],n=_(5),a=_(null),b=`
  #ifdef GL_ES
