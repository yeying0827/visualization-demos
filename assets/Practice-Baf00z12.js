import{G as m}from"./gl-renderer--j5iNyII.js";import{r as v,o as l,a as f,c as d,b as n,F as u}from"./index-a4tGsWeP.js";import"./_commonjsHelpers-5-cIlDoe.js";const g=n("h3",null,"课后练习",-1),_=`
...
`,j={__name:"Practice",setup(h){const r=v(null);let e,t;l(()=>{e=new m(r.value),a(0),s()});const a=o=>{switch(o){case 0:t=e.compileSync(p,_),e.useProgram(t),e.uniforms.uTime=0,requestAnimationFrame(function i(c){e.uniforms.uTime=.001*c,requestAnimationFrame(i)});break}},s=()=>{e.setMeshData([{positions:[[-1,-1],[-1,1],[1,1],[1,-1]],attributes:{uv:[[0,0],[0,1],[1,1],[1,0]]},cells:[[0,1,2],[2,0,3]]}]),e.render()};return(o,i)=>(f(),d(u,null,[g,n("canvas",{ref_key:"glRef",ref:r,width:"512",height:"512"},null,512)],64))}};export{j as default};
